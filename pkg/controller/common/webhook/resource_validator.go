...
func (v *ResourceValidator[T]) WithNamespaceMatcher(m *namespacematcher.Matcher) *ResourceValidator[T] {
...
func RegisterResourceWebhook[T runtime.Object](mgr ctrl.Manager, path string, checker license.Checker, managedNamespaces []string, matcher *namespacematcher.Matcher, validate ValidateFunc[T], resourceName string) {
