...
func RegisterWebhook(mgr ctrl.Manager, validateStorageClass bool, licenseChecker license.Checker, managedNamespaces []string, matcher *namespacematcher.Matcher) {
	inner := &validator{
